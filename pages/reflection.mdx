...
#### Response
The pursuit of knowledge is one feeling which I cannot compare to any other;
even more so begin to describe. Learning about the RSA Algorithm was one of the most
fascinating subjects I took a look at.

Most people are unaware, but RSA is an acronym Rivest–Shamir–Adleman, a public-key
cryptosystem that is one of the oldest and yet most widely used for data transmission.
It was developed secretly in 1973 at a British Intelligence Agency by an english
mathematician. Later on, it was declassifed for public use.

Getting my hands wet, and learning about the simple ingenuity behind the complex algorithm was
in my opnion quite interesting; even more so implementing it in an application.

<br/>
### Question 3
If you could change anything about this course, what would it be? How would envision it being implemented?
...
However, I would definitely improve the autograding system.
At many times, the grading bot would not be able to detect if my answer was correct
